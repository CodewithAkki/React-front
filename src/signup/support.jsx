                ...
                <div className="row gx-lg-5 align-items-center">
                  <div className="col-lg-6 mb-5 mb-lg-0">
                    <h1 className="my-5 display-3 fw-bold ls-tight">
                      ...
                      <span className="text-primary">knowledge is from compition</span>
                    </h1>
                    <p style={{color: 'hsl(217, 10%, 50.8%)'}}>
                      This is an online plateform for all compitative
                      project to store participate and get exciting prices that 
                      value your profile be the great be the best register now  
                    ...
                    <div className="card">
                      <div className="card-body py-5 px-md-5">
                        <form onSubmit={(e)=>submit(e)}>
                          ...
                          <div className="form-outline mb-4">
                            <input type="text" onChange={(e)=>handle(e)} value={data.email} id="email" placeholder='College name' className="form-control" />
                          </div>
                          <div className="form-outline mb-4">
                          ...
                          {/* Submit button */}
                          <button type="submit" className="btn btn-primary btn-block mb-5 w-10" >
                            Sign up
                          </button>
                          {/* Register buttons */}
